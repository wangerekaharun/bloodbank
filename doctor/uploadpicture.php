...
$account = mysqli_fetch_array($account1);
	...
	$query = $MySQLi_CON->query("SELECT  password, ppic FROM doctorregister WHERE email='$_SESSION[userSessionDoctor]'");
	...
	{		
		...
		$userpass = $_POST['password'];// user name
		...
		if(empty($userpass)){
			$errMSG = "<div class='alert bg-info'>
						<button class='close' data-dismiss='alert'>&times;</button> Please enter your Password !!!
					</div>";
			...
			$errMSG = "<div class='alert bg-info'>
						<button class='close' data-dismiss='alert'>&times;</button> Incorrect Password entered !!!
					</div>";
		}
            ...
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
					...
					<li class="nav-item"><a class="nav-link link" href="account">ACCOUNT</a></li>
					  ...
					  <li class="nav-item"><a class="nav-link link" href="search.html">SEARCH</a></li><li class="nav-item"><a class="nav-link link" href="about.html">ABOUT</a></li><li class="nav-item dropdown"><a class="nav-link link dropdown-toggle" href="https://mobirise.com/" data-toggle="dropdown-submenu" aria-expanded="false">HELP</a><div class="dropdown-menu"><a class="dropdown-item" href="contact.html">CONTACT US</a><a class="dropdown-item" href="faqs.html">FAQS</a></div></li></ul>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	   <div class="col-md-6" >
        ...
        <input class="text-input" type="password" name="password" placeholder="Enter password"   />
