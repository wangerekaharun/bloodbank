...
<section class="mbr-section mbr-after-navbar" id="msg-box3-v" style="background-color: #dddddd; padding-top: 60px; padding-bottom: 10px;">
    ...
    <div class="container">
        ...
        <div class="blog-header">
            <h1 class="blog-title">The Bloodbank Blog </h1>
            <p class="lead blog-description">The official blog of Bloodbank.</p>
        </div>
                            ...
                            if($count > 0) {
                                ...
                                <span><input type="checkbox" name="chk[]" class="chk-box" value="<?= $ft['0'] ?>"/>
                                    <h2 class="blog-post-title"><?= $ft['1'] ?></h2></span>
                                            ...
                                            <?= $ft['6'] ?> <div class="collapse" id="news">
                                                <?= $ft['7'] ?></div>
                                            <a class="a-red" data-toggle="collapse"  href="#news">Read More</a>
                                            <hr>
                                        </td>
                                    </tr>
